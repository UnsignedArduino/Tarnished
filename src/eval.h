...
const int PIECE_VALUES[7] = {100, 316, 328, 493, 982, 0, 0};


const Score pieceTypeValues[6] = {S(65, 183), S(344, 473), S(304, 513), S(555, 816), S(1166, 1442), S(0, 0)};

const Score kingLineDanger[28] = {S(0, 0), S(0, 0), S(30, 13), S(22, 47), S(9, 45), S(8, 29), S(6, 27), S(0, 33), S(-6, 34), S(-18, 34), S(-14, 31), S(-30, 37), S(-39, 35), S(-53, 36), S(-64, 36), S(-72, 35), S(-83, 31), S(-83, 24), S(-94, 19), S(-105, 13), S(-115, 9), S(-130, -1), S(-139, -11), S(-188, -26), S(-184, -42), S(-206, -54), S(-130, -32), S(-135, -34), };
...
const Score kingAttacks[4] = {S(11, -2), S(20, 0), S(27, -4), S(16, 21)};

const Score bishopPair = S(14, 87);
